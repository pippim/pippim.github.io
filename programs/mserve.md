...
{% include image.html src="/assets/img/mserve/mserve rename Greatest Hits Of The 80's [Disc 3].png"
   ...
   style="float: none; width: 640px; margin: 2rem 0 1rem 0;"
...
your phone sideways (Landscape Mode) to see all columns.

{% include_relative mserve_incl.md %}

*Table was updated {{ site.refreshed | date: "%B %e, %Y" }}.
The table is autogenerated when `refresh.sh` calls `mserve_config.py`
which writes output to `~/website/programs/mserve_incl.md`*
