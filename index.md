...
At the top of the page, in big bold letters, is front matter 
`title:`. Then you
see "**iews: 4006** generated by front matter `views:` Followed by
**Votes: 11** generated by `votes:`. The **Answer was ACCEPTED!** was
generated by: `accepted:` not being blank and containing
the string "Accepted". 

Finally the link: [🔍 See Original Answer on Ask Ubuntu]
(https://askubuntu.com/questions/1039357/a-timer-to-set-up-different-alarms-simultaneously/1039377#1039377)
is generated by three front matter variables. The link
itself is provided by `stack_url:`, the word "Answer"
is provided by `type:` and "Ask Ubuntu" is generated
by `site:`.
