...
The blog post title appears at the top of the page
in large letters. In this case it is: 
**A timer to setup different alarms simultaneously**.
The titel is derived from the front matter variable 
called `title:`.

In the middle you see **Views:** <mark>4006</mark>
which is generated by front matter `views:` Followed by
**Votes:** <mark>11</mark> generated by `votes:`. 

Next the <mark>Answer was 
ACCEPTED!</mark> text is generated by the front matter
variable `accepted:` containing the
...
This link to the Stack Exchange post is generated 
by three front matter global variables
declared in `stack-to-blog.py`:
