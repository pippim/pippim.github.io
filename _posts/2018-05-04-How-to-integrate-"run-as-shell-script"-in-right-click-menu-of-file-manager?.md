---
layout:       post
title:        How to integrate "run as shell script" in right click menu of file manager?
site:         Ask Ubuntu
...
Reboot and enjoy your new login and lock screen wallpaper.
  ...
  [3]: https://pippim.github.io/2017/01/13/Nautilus-can-set-desktop-wallpaper.-How-can-it-set-login-and-lock-screen-wallpaper?.html
