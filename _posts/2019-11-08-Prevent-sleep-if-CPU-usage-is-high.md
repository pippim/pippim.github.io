---
layout:       post
title:        Prevent sleep if CPU usage is high
site:         Ask Ubuntu
...
```
  ...
  [1]: https://pippim.github.io/2019/07/01/Turn-off-all-monitors-while-watching-VLC-media-on-TV.html
  [2]: https://i.stack.imgur.com/Dxo3M.png
  [3]: https://pippim.github.io/2019/11/07/How-to-get-real-uptime?.html
