...
```
  ...
  [1]: https://pippim.github.io/2018/02/21/How-to-find-previous-boot-log-after-Ubuntu-16.04+-restarts?.html
  [2]: https://pippim.github.io/2018/03/08/Systemd-logs-(`journalctl`)-are-too-large-and-slow.html
