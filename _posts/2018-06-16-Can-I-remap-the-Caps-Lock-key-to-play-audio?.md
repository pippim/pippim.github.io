...
**VLC** won't recognize media keys: https://askubuntu.com/questions/48393/how-to-make-the-keyboard-media-keys-to-work-with-vlc-globally even when built into the keyboard. Therefor the custom keyboard shortcut to XF86AudioPlay is useless with `xdotool`.
...
This Q&A discusses how to set custom keyboard shortcuts from the command line: https://askubuntu.com/questions/597395/how-to-set-custom-keyboard-shortcuts-from-terminal
