...
Most users won't need all these packages. Usually just `headers`, `image`, `image-extra` and `signed-image`.
  ...
  [18]: https://pippim.github.io/2018/01/27/Samsung-M2-NVME-enters-read-only-on-linux-every-day,-not-on-Windows.html
  ...
  [26]: https://pippim.github.io/2017/02/20/How-to-update-kernel-to-the-latest-mainline-version-without-any-Distro-upgrade?.html
