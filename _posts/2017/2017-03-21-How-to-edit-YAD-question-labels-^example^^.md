...
git_md_url:   https://github.com/pippim/pippim.github.io/blob/main/_posts/2017/2017-03-21-How-to-edit-YAD-question-labels-^example^^.md
toc:          false
navigation:   false
clipboard:    true
---
...
```
  ...
  [1]: {% post_url /2017/2017-03-25-Bash-template-to-use-zenity-^or-yad^-to-insert-^-edit-^-delete-records-in-a-file-or-database %}
