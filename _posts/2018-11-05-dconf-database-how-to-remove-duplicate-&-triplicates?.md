...
```
  ...
  [1]: https://pippim.github.io/2018/03/18/Bash-one-liner-to-display-ALL-`gsettings`-in-GUI-dialog-window.html
  [2]: https://i.stack.imgur.com/j9qV3.png
  [3]: https://pippim.github.io/2018/05/23/How-to-make-locate-output-look-like-`ll`-or-`ls--la`-but-nicer?.html
