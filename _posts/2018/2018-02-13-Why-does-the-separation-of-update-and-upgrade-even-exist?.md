...
git_md_url:   https://github.com/pippim/pippim.github.io/blob/main/_posts/2018/2018-02-13-Why-does-the-separation-of-update-and-upgrade-even-exist?
toc:          false
navigation:   false
clipboard:    false
---
...
### Without a separate `apt update` you can't see what would be upgraded!
  ...
  [1]: {% post_url /2018/2018-02-04-How-can-PPAs-be-removed-using-GUI? %}
