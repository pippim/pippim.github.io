...
Most users won't need all these packages. Usually just `headers`, `image`, `image-extra` and `signed-image`.
  ...
  [18]: {% post_url /2018/2018-01-27-Samsung-M2-NVME-enters-read-only-on-linux-every-day_-not-on-Windows %}
  ...
  [27]: https://pippim.github.io/assets/img/posts/2018/VOt2M.png
