...
git_md_url:   https://github.com/pippim/pippim.github.io/blob/main/_posts/2018/2018-06-17-source-command-error-from-∕usr∕share∕bash-completion∕bash-completion-when-I-open-a-terminal
toc:          false
navigation:   false
clipboard:    true
---
